...
public class DataWatcherType<T> {
    ...
    public static final DataWatcherType<Vector3fc> VECTOR3F;
    ...
    public static final DataWatcherType<Quaternionfc> QUATERNION;
    ...
    static {
        ...
        VECTOR3F = new DataWatcherType<>(Vector3fc.class, EntityDataSerializers.VECTOR3);
        ...
        QUATERNION = new DataWatcherType<>(Quaternionfc.class, EntityDataSerializers.QUATERNION);
    }
