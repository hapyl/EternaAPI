...
public class TalkToMultipleNpcQuestObjective extends AbstractDialogQuestObjective {
    ...
    private final Map<Npc, Entry> dialogs;
     ...
     * @see TalkToMultipleNpcQuestObjective#entry(Npc, Dialog, Dialog)
     */
     ...
     * or {@code null} if the given {@link Npc} does not have a dialog in this objective.
     *
     ...
     */
    @Nullable
    public Dialog getDialog(@Nonnull Npc npc, @Nonnull Player player) {
     ...
     */
    @Nonnull
    public static Entry entry(@Nonnull Npc npc, @Nonnull Dialog dialog, @Nullable Dialog backingDialog) {
    ...
    public static class Entry {
        ...
        private Entry(Npc npc, Dialog dialog, Dialog dialogTalked) {
            this.npc = npc;
            this.dialog = dialog;
