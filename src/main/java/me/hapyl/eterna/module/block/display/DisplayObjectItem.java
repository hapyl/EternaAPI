...
/**
 * Represents a {@link DisplayObject} of an {@link ItemDisplay}.
 */
public final class DisplayObjectItem extends DisplayObject<ItemDisplay> {
    ...
    DisplayObjectItem(@NotNull JsonObject json, @NotNull ItemStack itemStack, @NotNull ItemDisplay.ItemDisplayTransform transform) {
    ...
    @Override
    public void onCreate(@NotNull ItemDisplay display) {
