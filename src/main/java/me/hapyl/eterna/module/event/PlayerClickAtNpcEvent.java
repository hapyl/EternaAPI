...
public class PlayerClickAtNpcEvent extends PlayerEvent implements Cancellable {
    ...
    @ApiStatus.Internal
    public PlayerClickAtNpcEvent(@NotNull Player who, @Nonnull Npc npc, @Nonnull ClickType clickType) {
        super(who);
    ...
    public enum ClickResponse {
        /**
         * Passes the {@link Npc#onClick(Player, ClickType)} and starts the interaction cooldown.
         */
        OK,
        
        /**
         * Cancels the {@link Npc#onClick(Player, ClickType)} and doesn't start the interaction cooldown.
         */
        CANCEL,
        
        /**
         * Cancels the {@link Npc#onClick(Player, ClickType)} but <b>does</b> start the interaction cooldown.
         */
        HOLD
    }
}
