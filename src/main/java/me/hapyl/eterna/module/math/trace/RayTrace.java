package me.hapyl.eterna.module.math.trace;
...
public class RayTrace implements Traceable {
    ...
    public RayTrace(@Nonnull Location location, @Nonnull Properties properties) {
        this.startLocation = location;
        this.properties = properties;
    }

    public RayTrace(@Nonnull Location location) {
        this.startLocation = location;
    ...
    public final void trace() {
        ...
        for (double i = 0; i < getProperties().getMaxDistance(); i += getProperties().getShift()) {
            ...
            Traceable.getNearbyLivingEntities(location, properties.getSearchRadius(), entity -> getProperties().predicateEntity(entity))
                    .forEach(this::onHit);
            onMove(location);
