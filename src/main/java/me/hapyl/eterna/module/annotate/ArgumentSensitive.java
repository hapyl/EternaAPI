 ...
 * be targeted by {@link me.hapyl.eterna.module.command.CommandProcessor}
 * to call it if {@link ArgumentSensitive#targetSize()} and {@link ArgumentSensitive#targetString()}
 * matches to execute it.
 * <p>
 * Notice that annotated method must be a member of {@link me.hapyl.eterna.module.command.SimpleCommand} class
