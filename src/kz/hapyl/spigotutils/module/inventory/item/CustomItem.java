...
import kz.hapyl.spigotutils.module.nbt.LazyType;
...
public abstract class CustomItem {
	...
	public void setSmartLore(String lore) {
		this.lore = ItemBuilder.splitAfter(lore, 35);
	}

	public void addSmartLore(String lore) {
		this.lore.addAll(ItemBuilder.splitAfter(lore, 35));
	}
	...
	public final void register() {
		CustomItemHolder.getInstance().register(this);
	}

	public final void unregister() {
		CustomItemHolder.getInstance().unregister(this);
	}
